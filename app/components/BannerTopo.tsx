...
export default function BannerTopo() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center sm:gap-2">
        {/* Conteúdo central */}
        ...
        {/* Botão "Já sou aluno" — abaixo à direita no mobile, inline no sm+ */}
        <a
          href="/membros"
          className="self-end sm:self-auto flex items-center gap-1.5 bg-white/15 hover:bg-white/25 transition-colors text-white text-xs font-semibold px-3 py-1 rounded-full border border-white/30 shrink-0 whitespace-nowrap mt-1 sm:mt-0"
        >
          <LogIn size={13} />
          Já sou aluno
        </a>
