...
export default function Footer() {
  return (
    <footer className="bg-[#0F172A] text-white" id="footer">
          ...
          <div className="flex flex-col sm:flex-row gap-8 text-center md:text-left">
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><a href="#beneficios" className="hover:text-[#0188FA] transition-colors">Benefícios</a></li>
                <li><a href="#como-funciona" className="hover:text-[#0188FA] transition-colors">Como Funciona</a></li>
                <li><a href="#bonus" className="hover:text-[#0188FA] transition-colors">Bônus</a></li>
                <li><a href="#pricing" className="hover:text-[#0188FA] transition-colors">Preços</a></li>
              </ul>
            </div>
            <div>
              <h4
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="/privacidade" className="hover:text-[#0188FA] transition-colors">Política de Privacidade</Link></li>
                <li><Link href="/termos" className="hover:text-[#0188FA] transition-colors">Termos de Uso</Link></li>
                <li><Link href="/reembolso" className="hover:text-[#0188FA] transition-colors">Política de Reembolso</Link></li>
              </ul>
            </div>
          </div>
        </div>
